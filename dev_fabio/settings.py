"""
Django settings for dev_fabio project.
...
DEBUG = True
ALLOWED_HOSTS = ['devfab.herokuapp.com', '127.0.0.1']
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'devfab'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'devfab@example.com'
else:
    ...
    EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASS', 'ajnxsicyifjjlhit')
